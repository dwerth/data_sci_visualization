...
# Callback to disable the "select year" dropdown based on selected statistics
@app.callback(
    ...
    if selected_statistics == "Recession Period Statistics":
        ...
        R_chart4 = dcc.Graph(
            figure=px.bar(
                ...
                y="Automobile_Sales",
                color="Vehicle_Type",
                title="Impact of Unemployment Rate on Vehicle Type and Sales",
            )
        )
    ...
    # TASK 2.6 Create and display graphs for Yearly Report Statistics
        ...
        Y_chart2 = dcc.Graph(
            figure=px.line(
                ...
                x="Month",
                y="Automobile_Sales",
                title="Monthly Automobile Sales Fluctuation over Whole Period",
            )
        )
        ...
        Y_chart4 = px.pie(
            ...
            values="Advertising_Expenditure",
            names="Vehicle_Type",
            title="Share of Ad Spend by Vehicle Type during Recessions",
        )
